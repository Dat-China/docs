...
If `cached` is set to `true`, this function returns results from the local version of the archive鈥檚 append-tree. Default behavior is to fetch the latest remote version of the archive before returning list of directories.
